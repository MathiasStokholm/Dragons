export default function getTceSpells() {
    return (
        [
            {
                ...
                "entriesHigherLevel": [
                    {
                        ...
                        "name": "At Higher Levels",
                        "entries": [
                            "When you cast this spell using a spell slot of 2nd level or higher, the damage increases by {@dice 2d4} for each slot level above 1st."
                        ]
                    }
                ],
                "damageInflict": [
